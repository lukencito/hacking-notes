...
```shell-session
notluken@htb[/htb]$ nmap <scan types> <options> <target>
```
...
```shell-session
notluken@htb[/htb]$ sudo nmap -sS localhost
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.0/24 -sn -oA tnet | grep for | cut -d" " -f5
...
```shell-session
notluken@htb[/htb]$ cat hosts.lst
...
```shell-session
notluken@htb[/htb]$ sudo nmap -sn -oA tnet -iL hosts.lst | grep for | cut -d" " -f5
...
```shell-session
notluken@htb[/htb]$ sudo nmap -sn -oA tnet 10.129.2.18 10.129.2.19 10.129.2.20| grep for | cut -d" " -f5
...
```shell-session
notluken@htb[/htb]$ sudo nmap -sn -oA tnet 10.129.2.18-20| grep for | cut -d" " -f5
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.18 -sn -oA host
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.18 -sn -oA host -PE --packet-trace
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.18 -sn -oA host -PE --reason
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.18 -sn -oA host -PE --packet-trace --disable-arp-ping
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.28 --top-ports=10
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.28 -p 21 --packet-trace -Pn -n --disable-arp-ping
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.28 -p 443 --packet-trace --disable-arp-ping -Pn -n --reason -sT
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.28 -p 139 --packet-trace -n --disable-arp-ping -Pn
#
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.28 -p 445 --packet-trace -n --disable-arp-ping -Pn
#
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.28 -F -sU
#
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.28 -sU -Pn -n --disable-arp-ping --packet-trace -p 137 --reason
#
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.28 -sU -Pn -n --disable-arp-ping --packet-trace -p 100 --reason
#
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.28 -sU -Pn -n --disable-arp-ping --packet-trace -p 138 --reason
#
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.28 -Pn -n --disable-arp-ping --packet-trace -p 445 --reason  -sV
#
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.28 -p- -oA target
#
...
```shell-session
notluken@htb[/htb]$ cat target.nmap
#
...
```shell-session
notluken@htb[/htb]$ cat target.gnmap
#
Nmap 7.80 scan initiated Tue Jun 16 12:14:53 2020 as: nmap -p- -oA target 10.129.2.28
...
```shell-session
notluken@htb[/htb]$ cat target.xml
#
...
```shell-session
notluken@htb[/htb]$ xsltproc target.xml -o target.html
```
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.28 -p- -sV
#
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.28 -p- -sV --stats-every=5s
#
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.28 -p- -sV -v
#
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.28 -p- -sV -Pn -n --disable-arp-ping --packet-trace
#
...
```shell-session
notluken@htb[/htb]$ sudo tcpdump -i eth0 host 10.10.14.2 and 10.129.2.28
#
...
```shell-session
notluken@htb[/htb]$  nc -nv 10.129.2.28 25
#
...
```shell-session
notluken@htb[/htb]$ sudo nmap <target> -sC
```
...
```shell-session
notluken@htb[/htb]$ sudo nmap <target> --script <category>
```
...
```shell-session
notluken@htb[/htb]$ sudo nmap <target> --script <script-name>,<script-name>,...
```
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.28 -p 25 --script banner,smtp-commands
#
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.28 -p 80 -A
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.28 -p 80 -sV --script vuln
#
Nmap scan report for 10.129.2.28
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.0/24 -F
#
<SNIP>
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.0/24 -F --initial-rtt-timeout 50ms --max-rtt-timeout 100ms
#
<SNIP>
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.0/24 -F | grep "/tcp" | wc -l
#
23
```
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.0/24 -F --max-retries 0 | grep "/tcp" | wc -l
#
21
```
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.0/24 -F -oN tnet.default
#
<SNIP>
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.0/24 -F -oN tnet.minrate300 --min-rate 300
#
<SNIP>
...
```shell-session
notluken@htb[/htb]$ cat tnet.default | grep "/tcp" | wc -l
#
23
```
...
```shell-session
notluken@htb[/htb]$ cat tnet.minrate300 | grep "/tcp" | wc -l
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.0/24 -F -oN tnet.T5 -T 5
...
```shell-session
notluken@htb[/htb]$ cat tnet.T5 | grep "/tcp" | wc -l
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.28 -p 21,22,25 -sS -Pn -n --disable-arp-ping --packet-trace
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.28 -p 21,22,25 -sA -Pn -n --disable-arp-ping --packet-trace
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.28 -p 80 -sS -Pn -n --disable-arp-ping --packet-trace -D RND:5
#
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.28 -n -Pn -p445 -O
#
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.28 -n -Pn -p 445 -O -S 10.129.2.200 -e tun0
#
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.28 -p50000 -sS -Pn -n --disable-arp-ping --packet-trace
#
...
```shell-session
notluken@htb[/htb]$ sudo nmap 10.129.2.28 -p50000 -sS -Pn -n --disable-arp-ping --packet-trace --source-port 53
#
...
```shell-session
notluken@htb[/htb]$ ncat -nv --source-port 53 10.129.2.28 50000
